      ...
      <div>
        ...
        >
          <div className="flex gap-x-10">
            <div className="heroSectionDiv h-90 w-90 rounded-xl shadow-xl/30 z-10 bg-white">
              <img
                src="../degree_cap_image.jpg"
                alt=""
            ...
            <div className="heroSectionDiv h-90 w-90 rounded-xl shadow-xl/30 z-10 bg-white">
              <img
                src="../suitcase_image.JPG"
                alt=""
                className="h-60 w-60 z-20 relative top-8 left-15"
              />
              <p className="z-10 text-center font-bold text-xl relative top-10">
                Career Resources
              </p>
            </div>
            <div className="heroSectionDiv h-90 w-90 rounded-xl shadow-xl/30 z-10 bg-white">
              <img
                src="../glowing_bulb_image.jpg"
                alt=""
        ...
        <div className="w-full flex justify-around m-5">
          <div className="h-90 w-90 rounded-xl shadow-xl/30 z-10 bg-white flex flex-col justify-around p-10">
